...
echo "Compiling Project8_CossacksStrategy (requires SDL2)..."
g++ Project8_CossacksStrategy/main.cpp -o Project8_CossacksStrategy/cossacks_strategy `sdl2-config --cflags --libs` || echo "⚠️ SDL2 not installed. Skipping Cossacks Strategy."
